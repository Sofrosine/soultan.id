...
import { Inter, Instrument_Serif, JetBrains_Mono, Chakra_Petch } from 'next/font/google';
import './globals.css';
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${inter.variable} ${instrumentSerif.variable} ${jetbrainsMono.variable} ${chakraPetch.variable} scroll-smooth`}
    >
      <body>
        <div className="app">
          <Header />
