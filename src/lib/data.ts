...
export const projects: Project[] = [
    {
        ...
        technologies: ['Python', 'Claude (Anthropic SDK)', 'LangGraph', 'PostgreSQL', 'pgvector', 'SQLAlchemy', 'APScheduler', 'python-telegram-bot', 'Docker'],
...
export const experiences: Experience[] = [
    {
        ...
        description: [
            'Developed Java services to handle payment gateway callbacks, processing callback events and publishing updates to Solace for downstream consumers.',
            'Built cron-based reconciliation jobs and partial-payment handling to keep the database in sync with callback data from the payment gateway.',
        ],
        tech: ['Java', 'Solace', 'PostgreSQL', 'Payment Gateway', 'Cron Jobs'],
    },
    {
        ...
        description: [
            'Built real-time AI chat streaming and Contract Lifecycle Management (CLM) features, enabling seamless legal consultations with the AI assistant.',
            'Developed chat-with-document functionality including AI-powered document drafting, in-chat document review, and document canvas features for end-to-end legal document workflows.',
            'Collaborated with Backend & AI teams to integrate multiple AI capabilities, ensuring accurate and accessible legal information delivery across all platform features.',
        ],
        tech: ['React.js', 'AI Streaming', 'TypeScript', 'CLM'],
    },
    {
        title: 'Frontend Engineer',
        company: 'Hyperhire',
        ...
        description: [
            'Developed an internal compliance dashboard for legal enterprise clients to manage legal suite cases, enabling streamlined case tracking and reporting.',
            'Built a Reddit-like community platform for crypto enthusiasts with real-time discussions, content curation, and engagement-driven features.',
            'Delivered projects under very tight deadlines, consistently meeting aggressive timelines without compromising code quality or functionality.',
        ],
    ...
    },
    {
        ...
        description: [
            'Developed critical security systems with AWS Cognito and Lambda, ensuring high reliability and secure authentication.',
            'Delivered key projects: Authentication Security, Vulnerability Scanning, Log Search System, and CI/CD templates.',
            'Learned and applied advanced AWS features on the fly while delivering critical features under very tight deadlines.',
        ],
        tech: ['AWS Cognito', 'Lambda', 'Security', 'CI/CD'],
    },
    {
        ...
        description: [
            'Developed and optimized the mobile application with React Native, serving thousands of rural merchants across Indonesia.',
            'Led Play Store deployments and production builds, ensuring seamless release cycles and application stability.',
            'Delivered Payment System, Event Tracking, A/B Testing, and In-App Update features, driving business growth and user retention.',
        ],
