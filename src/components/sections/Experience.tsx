...
const experiences = [
  ...
  },
  {
    ...
    tech: ['JavaScript', 'CSS', 'HTML', 'Web Development', 'B2B E-commerce'],
  },
];
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-gray-700 dark:text-gray-300">
              My professional journey spanning international collaborations, startups, and diverse technical challenges.
            </p>
          </motion.div>
          ...
          >
            <div className="relative border-l-4 border-blue-600 pl-6 ml-4">
              {experiences.map((experience, index) => (
                  ...
                  >
                    {/* Timeline dot */}
                    <div className="absolute w-4 h-4 bg-blue-600 rounded-full -left-[34px] top-1.5 border-4 border-white dark:border-gray-800"></div>
