const JOURNEY: JourneyProps[] = [
  ...
  },
  {
    ...
    link: "https://dagangan.com",
  },
  {
    company: "Gomodo",
    description: [
      "Enhance mobile app for Gomodo product.",
      "Enhance web app for Gomodo product.",
      "Collaborate with Frontend & Backend Engineer, QA Engineer and Product Manager",
    ],
    duration: "Feb 2020 - Nov 2020",
    logo: "/logos/l-gomodo.png",
    role: "Mobile Engineer",
    link: "",
  },
  {
    company: "Fazztrack",
    description: [
      "Create RESTful API using ExpressJS",
      "Create Web Application using ReactJS",
      "Create Mobile Application using React Native",
    ],
    duration: "Dec 2019 - Jan 2020",
    logo: "/logos/l-fazztrack.png",
    role: "Fullstack Javascript Bootcamp",
    link: "https://www.fazztrack.com",
  },
];
